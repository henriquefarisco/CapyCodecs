...
void test_ico_decode_bmp_32bpp_alpha(void) {
  static const uint8_t ico32[] = {
      0x00u, 0x00u, 0x01u, 0x00u, 0x01u, 0x00u, 0x02u, 0x02u, 0x00u, 0x00u, 0x01u, 0x00u,
      0x20u, 0x00u, 0x40u, 0x00u, 0x00u, 0x00u, 0x16u, 0x00u, 0x00u, 0x00u, 0x28u, 0x00u,
      0x00u, 0x00u, 0x02u, 0x00u, 0x00u, 0x00u, 0x04u, 0x00u, 0x00u, 0x00u, 0x01u, 0x00u,
      0x20u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
      0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
      0x00u, 0x00u, 0x70u, 0x80u, 0x90u, 0xC0u, 0xA0u, 0xB0u, 0xC0u, 0xFFu, 0x10u, 0x20u,
      0x30u, 0x40u, 0x40u, 0x50u, 0x60u, 0x80u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
      0x00u, 0x00u
  };

  static const uint32_t expected[4] = {0x40302010u, 0x80605040u, 0xC0908070u, 0xFFC0B0A0u};
  struct test_heap heap;
  struct capy_image_allocator allocator;
  struct capy_image_inflater inflater;
  struct test_inflater_state ist;
  ...
  inflater.inflate = test_inflate_rgb_1x1;
  inflater.user_data = &ist;
  TEST_EXPECT(capy_ico_decode_memory(ico32, sizeof(ico32), &allocator,
                                     &inflater, &image) == CAPY_IMAGE_OK);
  TEST_EXPECT(image.width == 2u && image.height == 2u);
  TEST_EXPECT(image.pixels[0] == expected[0] && image.pixels[1] == expected[1] &&
              image.pixels[2] == expected[2] && image.pixels[3] == expected[3]);
  capy_image_rgba32_free(&image);
}

void test_ico_decode_bmp_24bpp_and_mask(void) {
  static const uint8_t ico24[] = {
      0x00u, 0x00u, 0x01u, 0x00u, 0x01u, 0x00u, 0x02u, 0x02u, 0x00u, 0x00u, 0x01u, 0x00u,
      0x18u, 0x00u, 0x40u, 0x00u, 0x00u, 0x00u, 0x16u, 0x00u, 0x00u, 0x00u, 0x28u, 0x00u,
      0x00u, 0x00u, 0x02u, 0x00u, 0x00u, 0x00u, 0x04u, 0x00u, 0x00u, 0x00u, 0x01u, 0x00u,
      0x18u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
      0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
      0x00u, 0x00u, 0x99u, 0x88u, 0x77u, 0xCCu, 0xBBu, 0xAAu, 0x00u, 0x00u, 0x33u, 0x22u,
      0x11u, 0x66u, 0x55u, 0x44u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x80u, 0x00u,
      0x00u, 0x00u
  };

  static const uint32_t expected[4] = {0x00112233u, 0xFF445566u, 0xFF778899u, 0xFFAABBCCu};
  struct test_heap heap;
  struct capy_image_allocator allocator;
  struct capy_image_inflater inflater;
  struct test_inflater_state ist;
  ...
  inflater.inflate = test_inflate_rgb_1x1;
  inflater.user_data = &ist;
  TEST_EXPECT(capy_ico_decode_memory(ico24, sizeof(ico24), &allocator,
                                     &inflater, &image) == CAPY_IMAGE_OK);
  TEST_EXPECT(image.width == 2u && image.height == 2u);
  TEST_EXPECT(image.pixels[0] == expected[0] && image.pixels[1] == expected[1] &&
              image.pixels[2] == expected[2] && image.pixels[3] == expected[3]);
